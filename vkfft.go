...
var (
	...
	ErrVkFFTFailEnabledSaveApplicationToString              = errors.New("vkFFT: Enabled saveApplicationToString")
	ErrVkFFTFailEmptyFile                                   = errors.New("vkFFT: Empty file")
	...
	ErrVkFFTFailEmptyApplicationString                      = errors.New("vkFFT: Empty applicationString")
	ErrVkFFTFailEmptyUseCustomBluesteinPaddingPatternArrays = errors.New("vkFFT: Empty usecustombluesteinpaddingpattern_arrays")
...
var errorMapVkFFT = map[C.VkFFTResult]error{
	...
	C.VKFFT_ERROR_ENABLED_saveApplicationToString:               ErrVkFFTFailEnabledSaveApplicationToString,
	C.VKFFT_ERROR_EMPTY_FILE:                                    ErrVkFFTFailEmptyFile,
	...
	C.VKFFT_ERROR_EMPTY_applicationString:                       ErrVkFFTFailEmptyApplicationString,
	C.VKFFT_ERROR_EMPTY_useCustomBluesteinPaddingPattern_arrays: ErrVkFFTFailEmptyUseCustomBluesteinPaddingPatternArrays,
